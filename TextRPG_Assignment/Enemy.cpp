...
void EnemyStrong::Attack(Character& player, EnemyStrong& enemy) {
	...
	if (attack1 >= player.GetArmorClass()) {
		std::cout << " hits!" << std::endl;
		// roll damage
		std::cout << player.GetName() << " takes " << enemy.GetEnemyDamage1() << " DAMAGE!!";
		player.TakeDamage(enemy.GetEnemyDamage1());
	}
	else {
		std::cout << enemy.GetName() << " misses!" << std::endl;
	}
...
void Boss::Attack(Character& player, Boss& enemy) {
	...
	std::cout << enemy.GetName() << " attacks " << player.GetName() << "!" << std::endl;
	// add modifiers
	std::cout << "Roll (" << attack1 << ") + " << enemy.GetBossToHitBonus() << std::endl;
	attack1 += enemy.GetBossToHitBonus();
	// compare to ac
	if (attack1 >= player.GetArmorClass()) {
		std::cout << " hits!" << std::endl;
		// roll damage
		std::cout << player.GetName() << " takes " << enemy.GetBossDamage1() << " DAMAGE!!";
		player.TakeDamage(enemy.GetBossDamage1());
	}
	else {
		std::cout << enemy.GetName() << " misses!" << std::endl;
	}
	...
	std::cout << enemy.GetName() << " attacks " << player.GetName() << "!" << std::endl;
	// add modifiers
	std::cout << "Roll (" << attack2 << ") + " << enemy.GetBossToHitBonus() << std::endl;
	attack2 += enemy.GetBossToHitBonus();
	// compare to ac
	if (attack2 >= player.GetArmorClass()) {
		std::cout << " hits!" << std::endl;
		// roll damage
		std::cout << player.GetName() << " takes " << enemy.GetBossDamage2() << " DAMAGE!!";
		player.TakeDamage(enemy.GetBossDamage2());
	}
	else {
		std::cout << enemy.GetName() << " misses!" << std::endl;
	}
	...
	std::cout << enemy.GetName() << " attacks " << player.GetName() << "!" << std::endl;
	// add modifiers
	std::cout << "Roll (" << attack3 << ") + " << enemy.GetBossToHitBonus() << std::endl;
	attack3 += enemy.GetBossToHitBonus();
	// compare to ac
